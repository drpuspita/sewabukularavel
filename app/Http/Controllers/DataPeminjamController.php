...
class DataPeminjamController extends Controller
{
    ...
    public function CobaCollection(){
        $daftar = ['Dwi Ratna', 'Puspita Sari', 'Bluereo'];
    ...
    public function collection_take(){
        $collection = DataPeminjam::all()->take();
        return $collection;
    }
    ...
    public function collection_tojson(){
        $data = [
            ['kode_peminjam' => 'P0001', 'nama_peminjam' => 'Dwi'],
            ['kode_peminjam' => 'P0002', 'nama_peminjam' => 'Ratna'],
            ['kode_peminjam' => 'P0003', 'nama_peminjam' => 'Puspita'],
            ['kode_peminjam' => 'P0004', 'nama_peminjam' => 'Sari'],            
        ];
